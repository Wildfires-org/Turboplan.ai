...
export const ganttDateRange = (
  ...
  switch (viewMode) {
    case ViewMode.Year:
      newStartDate = addToDate(newStartDate, preStepsCount ? -3 : -2, "month");
      newStartDate = startOfDate(newStartDate, "month");
      newEndDate = addToDate(newEndDate, 1, "year");
      newEndDate = startOfDate(newEndDate, "year");
      break;
    case ViewMode.QuarterYear:
      newStartDate = addToDate(newStartDate, preStepsCount ? -3 : 0, "month");
      newStartDate = startOfDate(newStartDate, "month");
      newEndDate = addToDate(newEndDate, 3, "year");
      newEndDate = startOfDate(newEndDate, "year");
      break;
    case ViewMode.Month:
      newStartDate = addToDate(newStartDate, preStepsCount ? -1 : -2, "month");
      newStartDate = startOfDate(newStartDate, "month");
    ...
    case ViewMode.Day:
      newStartDate = startOfDate(newStartDate, "day");
      newStartDate = addToDate(newStartDate, preStepsCount ? -14 : -2, "day");
      newEndDate = startOfDate(newEndDate, "day");
      newEndDate = addToDate(newEndDate, 14, "day");
      break;
    case ViewMode.QuarterDay:
      newStartDate = startOfDate(newStartDate, "day");
      newStartDate = addToDate(newStartDate, preStepsCount ? -1 : 0, "day");
      newEndDate = startOfDate(newEndDate, "day");
    ...
    case ViewMode.Hour:
      ...
      newStartDate = addToDate(newStartDate, preStepsCount ? -1 : 0, "hour");
      newEndDate = startOfDate(newEndDate, "day");
