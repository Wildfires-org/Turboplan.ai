...
const sources = {
  command: {
    dynamicColor: true,
    hasModel: true,
    source: "/animations/command-2.0.riv",
  },
  glint: {
    dynamicColor: true,
    hasModel: true,
    source: "/animations/glint-2.0.riv",
  },
  halo: {
    dynamicColor: true,
    hasModel: true,
    source: "/animations/halo-2.0.riv",
  },
  mana: {
    dynamicColor: false,
    hasModel: true,
    source: "/animations/mana-2.0.riv",
  },
  obsidian: {
    dynamicColor: true,
    hasModel: true,
    source: "/animations/obsidian-2.0.riv",
  },
  opal: {
    dynamicColor: false,
    hasModel: false,
    source: "/animations/orb-1.2.riv",
  },
};
