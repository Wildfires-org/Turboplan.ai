...
interface VersionFooterProps {
  ...
  artifactDefinition?: Artifact<string, unknown>;
  metadata?: unknown;
        ...
        <Button
          ...
          onClick={async () => {
            ...
            try {
              ...
              // Call onRestore callback if available
              if (artifactDefinition?.onRestore && documents) {
                const restoredDocument = documents[currentVersionIndex];
                if (restoredDocument?.content) {
                  try {
                    await artifactDefinition.onRestore({
                    ...
                    console.error(
                      "Failed to execute onRestore callback:",
                      error,
                    );
                  }
                }
